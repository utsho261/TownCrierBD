 ...
 *
 * Every user-visible string in the app should come from here instead of
 * being hard-coded, so the language can be switched at runtime.
 *
 * Pattern:
 *   AppStrings.get(context).feedTitle()  → "Feed" or "ফিড"
 *
 * Usage:
...
public class AppStrings {
    ...
    public String catDoneNone()          { return p("Please select at least one category", "অন্তত একটি ক্যাটাগরি নির্বাচন করুন"); }
